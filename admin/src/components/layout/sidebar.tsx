...
export function Sidebar({
  ...
  const navGroups = useMemo<NavGroup[]>(
    () => [
      {
        title: "Dashboards",
        items: [{ label: "Visao Geral", href: "/dashboard", icon: <LayoutDashboard size={18} /> }]
      },
      {
        title: "Operacional",
        items: [
          { label: "Pedidos", href: "/dashboard/pedidos", icon: <ClipboardList size={18} /> },
          { label: "Frete", href: "/dashboard/frete", icon: <Truck size={18} /> },
          { label: "Estoque", href: "/dashboard/estoque", icon: <Package size={18} /> },
          { label: "Produtos", href: "/dashboard/produtos", icon: <Boxes size={18} /> }
        ]
      },
      {
        title: "Configuracoes",
        items: [
          { label: "Funcionarios", href: "/dashboard/funcionarios", icon: <Users size={18} /> }
        ]
      }
    ],
    []
